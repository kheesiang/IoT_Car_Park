...
/*
  Test script for Arduino Controlling Slots in Level Two(2): L2_A1, L2_A2, L2_A3, L2_A4
...
void setup() {
  ...
  */
  // Ultrasonic Sensor for Slot L2_A1
  pinMode(trigPin1, OUTPUT);  
  pinMode(echoPin1, INPUT);   
  // Ultrasonic Sensor for Slot L2_A2
  pinMode(trigPin2, OUTPUT);
  pinMode(echoPin2, INPUT);
  // Ultrasonic Sensor for Slot L2_A3
  pinMode(trigPin3, OUTPUT);
  pinMode(echoPin3, INPUT);
  // Ultrasonic Sensor for Slot L2_A4
...
/* 
   * Ultrasonic Sensor For Parking Slot L2_A1
   */
  ...
  /* 
   * Ultrasonic Sensor Parking Slot L2_A2
   */
  ...
  /* 
   * Ultrasonic Sensor For Parking Slot L2_A3
   */
  ...
  /* 
   * Ultrasonic Sensor For Parking Slot L2_A4
   */
 ...
 // Code to test if something is in front of the sensor
  if (testCounter == 0) {
    ...
    Serial.println("EXPECTED OUTPUT: ALL SENSORS ARE RED.\n");
    testUltrasonic(distance, "L2_B1", "True");
    testUltrasonic(distance2, "L2_B2", "True");
    testUltrasonic(distance3, "L2_B3", "True");
    testUltrasonic(distance4, "L2_B4", "True");
  }
  ...
  // counter == 5 to allow for time to empty the parking slots
    ...
    Serial.println("EXPECTED OUTPUT: ALL SENSORS ARE GREEN.\n");
    testUltrasonic(distance, "L2_B1", "False");
    testUltrasonic(distance2, "L2_B2", "False");
    testUltrasonic(distance3, "L2_B3", "False");
    testUltrasonic(distance4, "L2_B4", "False");
  }
