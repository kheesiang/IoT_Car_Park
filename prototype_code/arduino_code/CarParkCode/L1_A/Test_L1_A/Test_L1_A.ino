...
/*
  Test Script for Arduino Controlling Slots L1_A1, L1_A2, L1_A3, L1_A4
...
/* 
  ...
  if (testCounter == 0) {
    ...
    testUltrasonic(distance4, "L1_A1", "True");
    testUltrasonic(distance3, "L1_A2", "True");
    testUltrasonic(distance2, "L1_A3", "True");
    testUltrasonic(distance, "L1_A4", "True");
    testUltrasonic(distanceG, "GATE", "True");
  }
  ...
  // counter == 5 to allow for time to empty the parking slots
    ...
    testUltrasonic(distance4, "L1_A1", "False");
    testUltrasonic(distance3, "L1_A2", "False");
    testUltrasonic(distance2, "L1_A3", "False");
    testUltrasonic(distance, "L1_A4", "False");
    testUltrasonic(distanceG, "GATE", "False");
  }
